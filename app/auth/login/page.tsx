    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1 text-center">
          <CardTitle className="text-3xl font-bold">IT Inventory</CardTitle>
          <CardDescription>
            Système de gestion de parc informatique
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {/* Mode développement - Connexion simple par email */}
          ...
          {/* Mode production - Google uniquement */}
          ...
          <p className="text-xs text-center text-muted-foreground">
            {process.env.NODE_ENV === 'development' 
              ? "Mode développement - Connexion simplifiée activée" 
